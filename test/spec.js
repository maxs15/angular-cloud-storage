...
describe('angular-storage', function () {
	...
	it('should read a directory', function(done){
		$storage.readdir('/').then(function(files) {
	...
	it('should write a file', function(done){
		$storage.writeFile('/test1.txt', 'test').then(function(file) {
	...
	it('should read a file', function(done){
		$storage.readFile('/test1.txt').then(function(file) {
	...
	it('should remove a file', function(done){
		$storage.remove('/test1.txt').then(function(file) {
			done();
		}, fail(done));
	});

	it('should create a directory', function(done){
		$storage.mkdir('test2').then(function(dir) {
	...
	it('should remove a directory', function(done){
		$storage.remove('/test2').then(function(file) {
			done();
		}, fail(done));
	});
